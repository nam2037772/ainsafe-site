...
const COMPANY = {
  ...
  brandSubline: '제주 노출콘크리트 보수·복원 전문',  // 브랜드 아래 한 줄 (헤더 · 히어로)
  /* 푸터 왼쪽 열의 회사 요약 한 줄 — 세 전문 분야를 모두 밝힙니다.
     brandSubline(헤더)과 다른 자리라 따로 둡니다: 헤더는 공간이 좁아
     짧은 한 줄만 넣고, 푸터는 세로로 쌓이는 열이라 온전한 범위를 적습니다. */
  footerSummary: '노출콘크리트 보수·복원 · 콘크리트 보수보강 · 인젝션 특수방수 전문',
  ...
  slogan: '제주 노출콘크리트 면보수 · 콘크리트 보수보강 · 인젝션 특수방수',
