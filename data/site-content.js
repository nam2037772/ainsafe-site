...
window.SITE = {
  ...
  meta: {
    title:       '제주 노출콘크리트 면보수 · 특수방수 | 주식회사 아인산업안전',
    description: '제주 노출콘크리트 면보수와 특수방수 전문 아인산업안전. 곰보·기포와 층조인트 단차, 균열 등 표면 결함을 덮지 않고 다시 만들어 넣고, 색보정으로 주변 면과 잇습니다. 누수 인젝션·액상고무 방수까지 제주시·서귀포시 현장에서 수행합니다.',
    ogDescription: '제주 노출콘크리트 면보수와 특수방수 전문 아인산업안전. 곰보·기포와 균열 등 표면 결함을 덮지 않고 다시 만들어 넣고, 색보정으로 주변 면과 잇습니다.',
    twitterDescription: '제주 노출콘크리트 면보수 · 색보정 · 균열 보수와 특수방수. 주식회사 아인산업안전.',
  ...
  hero: {
    title: '콘크리트를 케어하고,<br>원래의 표정을 다시 만듭니다.',   // 큰 제목
    en:    'Exposed Concrete Repair · Specialty Waterproofing', // 제목 아래 영문
    sub:   '노출콘크리트 복원과 특수방수로 본연의 질감과 성능을 되살립니다.', // 한 줄 설명
    images: [
  ...
  about: {
    eyebrow:  'About Us',
    heading:  '콘크리트의 시간과<br>표정을 이해하고,<br>본래의 모습으로 복원합니다.',
    paragraphs: [
      '노출콘크리트는 타설 순간의 결과가 그대로 외관이 됩니다. 곰보 하나, 층조인트 한 줄이 건물 전체의 인상을 바꿉니다. 아인산업안전은 제주특별자치도를 기반으로, 결함을 덮는 대신 주변 면의 질감과 색을 읽어 다시 만들어 넣는 방식으로 보수합니다.',
  ...
  serviceSection: {
    eyebrow: 'Service',
    heading: '콘크리트를 케어합니다.',
    desc:    '시간과 시공의 흔적을 세심하게 복원하고, 콘크리트 본연의 질감과 성능을 되찾습니다.'
  },
  services: [
    { no: '01', title: '노출콘크리트 복원',
      items: ['면보수', '색감 · 질감 재현'],
  ...
  featureSection: {
    ...
    heading: '자연스러운 노출콘크리트의<br>기준을 제시합니다.',
