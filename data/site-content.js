...
window.SITE = {
  ...
  meta: {
    title:       '노출콘크리트 면보수 · 특수방수 전문 | 주식회사 아인산업안전',
    description: '노출콘크리트 표면 결함 복원과 특수방수 전문. 곰보·기포 보수, 층조인트 단차 보정, 색상 및 질감 재현, 균열 보수, 누수 인젝션, 액상고무 방수, 발수·표면 보호. 결함을 덮지 않고 다시 만들어 넣는 보수.',
    ogDescription: '노출콘크리트 표면 결함 복원과 특수방수 전문. 곰보·기포 보수, 색상 및 질감 재현, 균열 보수, 누수 인젝션, 액상고무 방수. 결함을 덮지 않고 다시 만들어 넣는 보수.',
    twitterDescription: '노출콘크리트 표면 결함 복원과 특수방수 전문. 색상 및 질감 재현, 균열 보수, 누수 인젝션, 액상고무 방수.',
